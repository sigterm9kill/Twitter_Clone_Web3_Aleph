...
describe('mnemonicToLegacySeed', () => {
  ...
  it('generates a valid seed', () => {
    expect((0, _util.u8aToHex)((0, _.mnemonicToLegacySeed)(MENMONIC))).toEqual(SEED);
    expect((0, _util.u8aToHex)((0, _.mnemonicToLegacySeed)(MENMONIC, undefined, true))).toEqual(SEED);
  });
});